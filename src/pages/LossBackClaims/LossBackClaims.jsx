...
const LossBackClaims = () => {
  ...
  return (
    <div className="w-full h-full lg:w-[54%]">
      ...
      {data?.length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 px-4 py-6 font-lato">
          {data?.map((item) => {
            return (
              <div
      ...
      {data?.length === 0 && (
        <div className="flex items-center justify-center h-full flex-col gap-4 px-4 py-6 font-lato">
