  ...
  return (
    <div className="w-full h-full  lg:w-[54%] lg:pt-2">
      ...
      <div className=" w-full h-max font-lato py-3 px-2.5 flex flex-col gap-y-[15px]">
        ...
        >
          <div className="w-full h-full text-text_color_primary2 grid grid-cols-2 gap-x-2 z-[100] relative">
            <div className="col-span-1 flex justify-start items-start bg-bg_color_giftCardInputBg h-full text-text_color_primary2 flex-col px-3 py-0.5 rounded-lg relative">
              <div className="blur-[5px] bg-bg_color_giftCardInputBg w-full h-1/2 absolute bottom-0 left-0 z-0" />
              <h6 className="text-text_color_primary2 text-x xsm:text-xs sm:text-sm font-medium leading-[18px] tracking-[0.3px]">
                BONUS EARNED
              </h6>
              <p className=" text-text_color_primary2 text-lg font-bold leading-[28px] tracking-[0.3px]">
                <span className="font-roboto">₹</span> X,XXX.XX
              </p>
            </div>
            <div className="col-span-1 flex justify-start items-start bg-bg_color_giftCardInputBg h-full text-text_color_primary2 flex-col px-3 py-0.5 rounded-lg">
              <h6 className="text-text_color_primary2 text-x xsm:text-xs sm:text-sm font-medium leading-[18px] tracking-[0.3px]">
                FREE MONEY EARNED
              </h6>
              <p className=" text-text_color_primary2 text-lg font-bold leading-[28px] tracking-[0.3px]">
          ...
          <div className=" flex items-center justify-end gap-x-1.5 mt-1 z-10">
            <button
              ...
              type="button"
            >
              <p className="flex items-center w-full h-full gap-x-0.5  text-text_color_primary2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={15}
                  height={15}
            ...
            <button
              title="My Bonuses"
              id="my-bonuses"
              className="relative overflow-hidden text-text_color_primary2 px-2.5 py-0 h-[30px] rounded-md flex items-center justify-center  bg-bg_color_quaternary"
              aria-label="My Bonuses"
              type="button"
            >
              <p className="flex items-center w-full gap-x-0.5  text-text_color_primary2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={16}
                  height={17}
        ...
        <div className=" w-full  px-[9px] font-lato flex flex-col justify-center relative overflow-hidden rounded-[10px] bg-bg_color_GiftCardBg gap-y-1.5 pb-[9px]">
