    ...
    <footer className="pb-12 px-3 md:px-0 mt-1 w-full md:pr-0 mb:pb-0 md:pl-0 font-lato">
      ...
      >
        <div className="grid w-full grid-cols-12">
          ...
          <div className="col-span-4 lg:col-span-3 w-full h-max flex items-start flex-col gap-y-2 text-xs xs:text-sm px-3">
            <h3 className="text-text_color_primary1 font-normal text-start text-lg md:text-xl font-bold w-max">
              Customer Care
            </h3>
            <a
              href="tel:18008896851"
              title="Phone"
              className="flex items-center gap-x-2.5 w-max text-xs sm:text-sm text-text_color_primary1"
            >
              <svg
              ...
              <span className="font-bold">18008896851</span>
            </a>
          </div>
            ...
            <div className="w-full flex justify-center items-center md:items-start md:justify-start gap-2 lg:gap-2.5">
              ...
              <div className="flex items-center justify-center overflow-hidden rounded-md">
                <a
                  ...
                  href="https://instagram.com/_u/10sportsofficial/"
                  target="_blank"
                  className="flex items-center justify-center rounded-md bg-bg_color_secondary size-[45px] md:size-[50px] hover:scale-[110%] transition-all duration-300 hover:shadow-lg hover:opacity-90"
                >
                  <svg
        ...
        <div className="w-full grid py-4 px-3 grid-cols-2 xxs:grid-cols-3 sm:grid-cols-5 gap-4 place-items-center justify-center">
          ...
          <div className="w-full max-w-[150px] aspect-[3/1] relative">
            <div className="relative overflow-hidden absolute inset-0 h-full w-full">
              <img
                src="assets/images/bankTransfer.svg"
                alt="Bank Transfer"
                sizes="(max-width: 600px) 100vw, (max-width: 1200px) 50vw, 625px"
                className="w-full h-full object-contain"
                title="Bank Transfer"
          ...
          <div className="w-full max-w-[150px] aspect-[3/1] relative">
            <div className="relative overflow-hidden absolute inset-0 h-full w-full">
              <img
                src="assets/images/BeGambleAware.svg"
                alt="BeGamble Aware"
                sizes="(max-width: 600px) 100vw, (max-width: 1200px) 50vw, 625px"
                className="w-full h-full object-contain"
          ...
          <div className="w-full max-w-[150px] aspect-[3/1] relative">
            <div className="relative overflow-hidden absolute inset-0 h-full w-full">
              <img
                src="assets/images/gamblingCommission.svg"
