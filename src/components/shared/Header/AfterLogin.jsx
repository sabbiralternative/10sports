...
const AfterLogin = ({ setShowRightDrawer, setShowMobileSearch }) => {
  ...
  return (
    <>
      <div
        id="loginName"
        className=" text-text_color_primary2 text-[10px] lg:text-[12px] lg:flex flex-col px-2 hidden"
      >
        <div className="flex gap-0.5 text-white/80  xl:text-nowrap whitespace-nowrap">
          Available balance:{" "}
          <span className="font-medium text-text_color_primary2">
            ₹{data?.availBalance}
          </span>
        </div>
      </div>
      ...
      "
            type="button"
          >
            <span className="text-text_color_primary2 capitalize border  flex rounded px-3 py-1  flex-col text-[10px]  hover:opacity-100 w-max font-semibold items-center justify-center  bg-bg_homeDepositBtnBgColor ">
              <svg
...
"
            type="button"
          >
            <span className="text-text_color_primary2 capitalize border  flex rounded px-3 py-1  flex-col text-[10px]  hover:opacity-100 w-max font-semibold items-center justify-center  bg-bg_homeWithdrawBtnBgColor ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="19"
