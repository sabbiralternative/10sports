...
const HeaderBottomNavItem = () => {
  ...
  return (
    <>
      ...
      {/* no-scrollbar */}
      <div className="flex w-full overflow-x-auto bg-bg_headerDeskNavMenu  py-[5px] px-3 items-start md:items-center md:justify-start max-w-full   mx-auto">
        <Link
          ...
          ?.map((item) => {
            return (
              <Link
                key={item?.eventName}
                title="Home"
                className={`cursor-pointer uppercase min-h-[28px] min-w-fit  max-w-fit px-[9px]  flex items-center justify-center gap-x-1 py-1 rounded-md text-sm
        ${
                  ...
                  >
                    <g clipPath="url(#clip0_145_9104)">
                      <path
                        ...
                        fill={`url(#paint0_linear_145_9104-${item?.pathname})`}
                      ></path>
                    </g>
                    <defs>
                      <linearGradient
                        id={`paint0_linear_145_9104-${item?.pathname}`}
                        x1="-1.12"
                        y1="-3.85125e-08"
                        x2="14.2675"
                        y2="1.30581"
