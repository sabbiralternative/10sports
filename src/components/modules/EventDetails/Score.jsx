    ...
    >
      ...
      <div className="sc_cw-main-container">
              ...
              >
                {iscore?.crr && (
                  <div style={{ paddingLeft: "30px", paddingRight: "30px" }}>
                    <span style={{ fontWeight: 600 }}>CRR: </span> {iscore?.crr}
                  </div>
                )}

                {iscore?.rrr !== null && iscore?.rrr != 0 && (
                  <div style={{ paddingLeft: "30px", paddingRight: "30px" }}>
                    <span style={{ fontWeight: 600 }}>RRR: </span> {iscore?.rrr}
                  </div>
                )}
        ...
        >
          ...
          >
            <div className="sc_cw-over">
              <span
                style={{
                  border: iscore?.recent_overs?.[0]?.title
                    ? ".25px solid #000000"
                    : "none",
                  borderRadius: "2px",
                  paddingLeft: "5px",
              ...
              >
                {iscore?.recent_overs?.[0]?.title}
              </span>
              {iscore?.recent_overs?.[0]?.balls?.map((ball, i) => (
            ...
            <div className="sc_cw-over">
              <span
                style={{
                  border: iscore?.recent_overs?.[1]?.title
                    ? ".25px solid #000000"
                    : "none",
                  borderRadius: "2px",
                  paddingLeft: "5px",
              ...
              >
                {iscore?.recent_overs?.[1]?.title}
              </span>
              {iscore?.recent_overs?.[1]?.balls?.map((ball, i) => (
                <div key={i} className="sc_cw-ball">
                  {ball}
                </div>
              ))}
        ...
        {iscore?.status || iscore?.status2 ? (
          ...
          >
            <div style={{ paddingLeft: "30px", paddingRight: "30px" }}>
              <span style={{ fontWeight: 600 }}> </span> {iscore?.status}
            </div>

            <div style={{ paddingLeft: "30px", paddingRight: "30px" }}>
              <span style={{ fontWeight: 600 }}></span> {iscore?.status2}
            </div>
          </div>
        ) : null}
        ...
        <div style={{ overflowX: "auto", width: "100%" }}>
          ...
          >
            ...
            >
              ...
              >
                <span style={{ marginLeft: "5px" }}>{iscore?.bowler}</span>
              </div>
              <div style={{ minWidth: "40px!important" }}>
                {iscore?.bowlerOvers}
              </div>
              <div style={{ minWidth: "40px!important" }}>-</div>
              <div style={{ minWidth: "40px!important" }}>
                {iscore?.bowlerRuns}
              </div>
              <div style={{ minWidth: "40px!important" }}>
