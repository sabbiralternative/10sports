    ...
    <div className="w-full px-[6px] grid  gap-2 grid-cols-2">
      <div>
        <div
          ...
          id="add Crypto"
          title="Add Crypto"
          className="relative overflow-hidden bg-bg_color_primary border shadow-sm hover:shadow-md transition-all duration-300 group rounded-md py-2 px-3 cursor-pointer active:scale-95 font-sans border-border_color_primary "
        >
      ...
      <div onClick={handleNavigate} className="group">
        <div
          id="referAndEarnCard"
          title="Refer & Earn"
          className="relative overflow-hidden bg-bg_headerBg  border border-primary shadow-sm hover:shadow-md transition-all duration-300 group rounded-md py-2 px-3 cursor-pointer active:scale-95 font-sans"
        >
          <div className="flex items-center gap-3 relative">
            <div className="relative flex-shrink-0 group-hover:animate-shake">
