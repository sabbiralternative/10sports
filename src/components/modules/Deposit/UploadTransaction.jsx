  ...
  return (
    <>
      ...
      <div className="flex items-start justify-center gap-x-2 py-3 px-5">
        ...
        <span className="text-sm text-text_color_primary1 font-lato font-[400] leading-5">
          I have read and agree with
          <span className="bg-bg_text_brand_primary text-transparent bg-clip-text underline text-sm font-lato font-[400] leading-4 cursor-pointer">
            {" "}
