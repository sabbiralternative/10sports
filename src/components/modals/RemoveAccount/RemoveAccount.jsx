        ...
        <div className="w-full flex items-center justify-center flex-col gap-y-4 mt-2">
          ...
          <div className="w-full flex items-center justify-center gap-x-2">
            ...
            <button
              ...
              className="inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out bg-primary text-base font-semibold font-lato text-text_Quaternary h-10 w-32 rounded-md flex items-center justify-center gap-x-1 cursor-pointer bg-bg_text_brand_primary"
              type="button"
            >
