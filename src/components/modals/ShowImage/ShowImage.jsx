        ...
        <div className="w-full gap-y-4 flex flex-col h-[90%]">
          ...
          <div className="w-full mt-auto">
            <button
              onClick={() => setShowImage("")}
              type="submit"
              className="inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out w-full text-text_Quaternary bg-bg_color_LoginBtnBgColor shadow-lg rounded-md xs:text-[15px] px-5 py-2 flex items-center justify-center gap-x-2 font-lato-bold font-semibold text-base cursor-pointer"
            >
              <span>Close</span>
            </button>
          </div>
