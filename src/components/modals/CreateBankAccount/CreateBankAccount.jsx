          ...
          >
            ...
            >
              <div title="loginFormMonileUserIdInput" className="w-full">
                ...
                <div className="flex w-full items-center py-3.5  rounded-lg border bg-bg_color_input_bg border-border_color_primary1">
                  <input
                    onChange={(e) => {
                      setBankDetails({
                        ...bankDetails,
                    ...
                    id="mobile-no-input"
                    className="px-2 block w-full focus:outline-none w-full font-lato bg-bg_color_input_bg text-text_Ternary pr-2 text-sm xs:text-md"
