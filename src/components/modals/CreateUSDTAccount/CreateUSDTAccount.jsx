...
const CreateUSDTAccount = ({ refetchBankAccounts, setShowAddUSDTModal }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          onClick={() => setShowAddUSDTModal(false)}
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <div className="flex w-full items-center gap-x-3 py-2 px-2 bg-bg_color_input_bg rounded-lg border border-border_color_primary1">
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <div className="flex w-full items-center py-2 px-2 bg-bg_color_input_bg rounded-lg border border-border_color_primary1">
                    <input
                      onChange={(e) => {
                        setUsdtDetails({
                          ...usdtDetails,
